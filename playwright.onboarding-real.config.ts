...
export default defineConfig({
  testDir: "./e2e",
  testMatch: /onboarding-real\.e2e\.spec\.ts/,
  reporter: "line",
  use: {
  ...
  webServer: [
    {
      command: `DATABASE_URL='${databaseUrl}' JWT_SECRET='onboarding-browser-secret' NODE_ENV=test PORT=3333 npx tsx src/server.ts`,
