...
function LogoAvatar({
  ...
  if (logoUrl && !imgError) {
    return (
      <img
        ...
        className={cn(
          sizeClass,
          "flex-shrink-0 rounded-full border border-white/10 object-cover",
        )}
  ...
  return (
    <div
      className={cn(
        sizeClass,
        "flex flex-shrink-0 items-center justify-center rounded-full border border-white/10 text-white font-black",
      )}
      style={{
