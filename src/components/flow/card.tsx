...
const cardRadiusStyles: Record<NonNullable<VariantProps<typeof cardVariants>["radiusSize"]>, React.CSSProperties> = {
...
export function Card({ className, variant, padding, radiusSize, style, ...props }: CardProps) {
